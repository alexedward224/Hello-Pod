podTemplate(
    ...
    node("myJenkins") {
        ...
        stage ('DEV - Image build'){
            ...
            buildApp('helloworld-msa-dev', "hello-pod")
        ...
        stage ('QA - Promote image'){
            ...
            promoteImage('helloworld-msa-dev', 'helloworld-msa-qa', 'hello-pod', 'latest')
        }
        ...
        stage ('PRD - Promote image'){
            ...
            promoteImage('helloworld-msa-qa', 'helloworld-msa', 'hello-pod', env.BUILD_NUMBER)
        }

        stage ('PRD - Canary Deploy'){
            echo 'Performing a canary deployment'
            canaryDeploy('helloworld-msa', 'hello-pod', env.BUILD_NUMBER)
        }
